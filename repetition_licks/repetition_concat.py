...
# Path to route file
route_path = "repetition_licks/route"

# Path to repetition lick results directory
result_lick_dir = "repetition_licks/result/"

# Path to sublicks data base
sublicks_dir = "repetition_licks/sublicks/"
...
if os.stat(route_path).st_size != 0:
	...
	with open(route_path, "r") as f:
		...
		for line in f:
			index += 1
			if index > 20:
				print("There is no valid solution (repetition)\n")
				sys.exit(1)
...
# CONCATENATION
	...
	print("There was an error in sublicks concatenation (repetition). Aborting...\n")
	sys.exit(1)
