...
# Path to route file
route_path = "default_licks/route"

# Path to default lick results directory
result_lick_dir = "gs_optimizer/lick_database/"

# Path to sublicks data base
sublicks_dir = "default_licks/sublicks/"
...
if os.stat(route_path).st_size != 0:
	...
	with open(route_path, "r") as f:
		...
		for line in f:
			index += 1
			if index > 20:
				print("There is no valid solution (default)\n")
				sys.exit(1)
...
# CONCATENATION
	...
	print("There was an error in sublicks concatenation (default). Aborting...\n")
	sys.exit(1)
